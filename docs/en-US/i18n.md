...
{
  plugins: [
    new webpack.NormalModuleReplacementPlugin(/forever-zu[\/\\]lib[\/\\]locale[\/\\]lang[\/\\]zh-CN/, 'forever-zu/lib/locale/lang/en')
  ]
}
```
...
import enLocale from 'forever-zu/lib/locale/lang/en'
import zhLocale from 'forever-zu/lib/locale/lang/zh-CN'
